...
public class JSONArray implements Iterable<Object> {
     ...
     */
    public JSONArray(org.json.JSONTokener tokener) throws JSONException {
        this();
    ...
    public String join(String separator) throws JSONException {
        ...
        for (int i = 0; i < length; i += 1) {
            ...
            builder.append(JSONObject.valueToString(this.myArrayList.get(i)));
        }
     ...
     * @param value A double value.
     * @return this.
     * @throws JSONException If index is negative or if the value is not finite.
     */
     ...
     * @return this.
     * @throws JSONException If the index is negative or if the the value
     ...
     * @return this.
     * @throws JSONException If index is negative or if value is an invalid num
     */
     ...
     * @return A JSONObject, or null if no names or if JSONArray has no values.
    ...
    public JSONObject toJSONObject(JSONArray names) throws JSONException {
        ...
        for (int i = 0; i < names.length(); i += 1) {
            jsonObj.put(names.getString(i), this.opt(i));
        }
        return jsonObj;
    }
